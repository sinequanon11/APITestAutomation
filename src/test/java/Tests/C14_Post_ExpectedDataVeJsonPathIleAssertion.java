...
public class C14_Post_ExpectedDataVeJsonPathIleAssertion {
    ...
    public void test01(){
        ...
        JsonPath responseJsonPath = response.jsonPath();  // JsonPath'i sadece response'ta kullanabiliyoruz

        // JUnit Assertion'da 1. expected, expectedData, 2. actual, responseJsonPath
